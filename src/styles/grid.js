...
export const Container = styled.div`
    ...
    @media ${device.sm} {
        max-width: ${props => (props.xsMaxWidth ? props.xsMaxWidth : '540px')};
    }

    @media ${device.md} {
        max-width: ${props => (props.xsMaxWidth ? props.xsMaxWidth : '720px')};
    }

    @media ${device.lg} {
        max-width: ${props => (props.xsMaxWidth ? props.xsMaxWidth : '960px')};
    }

    @media ${device.xl} {
        max-width: ${props => (props.xsMaxWidth ? props.xsMaxWidth : '1140px')};
    }
`;
...
function getWidthGrid(value) {
    ...
    switch (value) {
        ...
        default:
            ...
            return `max-widht: ${width}%; flex: 0 0 ${width}%;`;
    }
}
